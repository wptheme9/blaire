<?php
/**
 * Blaire functions and definitions.
 *
...
if ( ! function_exists( 'blaire_setup' ) ) :
/**
 ...
 */
function blaire_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on components, use a find and replace
	 * to change 'blaire' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'blaire', get_template_directory() . '/languages' );
	...
	add_image_size( 'blaire-featured-image', 640, 9999 );

	// This theme uses wp_nav_menu() in one location.
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Top', 'blaire' ),
		) );
	...
	add_theme_support( 'custom-background', apply_filters( 'blaire_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif;
add_action( 'after_setup_theme', 'blaire_setup' );
 ...
 */
function blaire_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'blaire_content_width', 640 );
}
add_action( 'after_setup_theme', 'blaire_content_width', 0 );
 ...
 */
function blaire_the_custom_logo() {
 ...
 */
function blaire_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'blaire' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'wp_enqueue_scripts', 'blaire_scripts' );
